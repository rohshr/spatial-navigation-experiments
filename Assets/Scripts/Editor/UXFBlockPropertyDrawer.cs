...
[CustomPropertyDrawer(typeof(SessionGenerator.UXFBlock), true)]
public class UxfBlockPropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.propertyType == SerializedPropertyType.ManagedReference && IsInTrialBlocksList(property))
        {
            ...
            {
                property.managedReferenceValue = new SessionGenerator.UXFBlock();
            ...
            var types = GetDerivedTypes(typeof(SessionGenerator.UXFBlock));
    ...
    private bool IsInTrialBlocksList(SerializedProperty property)
    {
        ...
        return path.Contains("trialBlocks.Array.data[") && 
    ...
    {
        if (type == typeof(SessionGenerator.UXFBlock))
